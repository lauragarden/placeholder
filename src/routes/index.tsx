...
function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-16 bg-[#FDFBF7]">
      <div className="text-center space-y-7">
        ...
        <div className="h-8 flex items-center justify-center">
          ...
          >
            <span
              className={`block w-6 h-px bg-[#3A5A40] transition-all duration-500 ${phase === "gone" ? "w-12" : ""}`}
            />
